...
var md5 = require('md5')
var fs = require('fs')
var logger = require('../common/logger').logger('live_logs_all_user_export');

module.exports = function(){
    var ep = new EventProxy()

    //创建报表文件
    var fileName = path.join(__dirname, '../../dashboard/report/live_logs_month_report(all_user).csv')
    ...
    ep.all('file_create',function(){
        ...
        stream.on('end',function(){
            logger.info('live_logs_all_user_export file saved!')
        })
    })
}
